    ...
    <div>
      ...
      <div className="bg-zinc-900 px-10 h-screen">
        <div className="bg-zinc-900 py-8 pb-0 flex justify-center">
          <h1 className="text-red-700 font-bold text-3xl font-sans">WOI WURRUNG DATABASE EXPLORER</h1>
        </div>
        <div className="bg-zinc-900 px-4 py-4">
          <h2 className="text-red-700 font-bold text-lg font-sans flex justify-center py-4">RECENTLY SEARCHED</h2>
